...
function getSyncStartAt(command) {
  const syncCommands = new Set(["home","youtube","news","sports","music","youtubepanel","youtubequeue","youtubequeuecontinuous"]);
  return syncCommands.has(String(command || "").toLowerCase()) ? Date.now() + 1800 : 0;
}
